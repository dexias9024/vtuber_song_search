...
RSpec.describe 'Request', type: :model do
  context "Requestを作ることができる" do
    ...
    it "1-6.重複したurlの場合、無効である" do
      user = create(:user)
      request1 = FactoryBot.create(:request, url: 'https://www.youtube.com/test', user_id: user.id)
